export const hangarCatalog = [
  ...
  { id: "start_shield", kind: "power", name: "Start Shield", description: "Activate one shield charge from quick select. Lasts up to 60 seconds or until hit.", pricePi: 0.08, powerUp: "shield" },
  { id: "start_rapid", kind: "power", name: "Start Rapid Fire", description: "Activate faster automatic fire from quick select for 60 seconds.", pricePi: 0.09, powerUp: "rapid" },
  { id: "start_overdrive", kind: "power", name: "Start Overdrive", description: "Activate stronger shots from quick select for 60 seconds.", pricePi: 0.12, powerUp: "overdrive" },
] as const;
